...
Users are not allowed to create Issues directly in this repository - we ask that you create a [Discussion][discussions] first.

This project **does not use the issue tracker for discussion or feature requests**. Instead, we use GitHub [discussions][discussions] for that. Once a discussion reaches a point where a well-understood, actionable item is identified, it is moved to the issue tracker. **This pattern makes it easier for maintainers or contributors to find issues to work on since every issue is ready to be worked on**.
...
Tip: also search for [closed issues][closed-issues] and [closed discussions][closed-discussions]; your issue might have already been fixed!
...
If your issue hasn't been reported already, open an ["Issue Triage"][issue-triage] discussion and make sure to fill in the template **completely**. They are vital for maintainers to figure out important details about your setup.
...
Like bug reports, first search through both issues and discussions and try to find if your feature has already been requested. Otherwise, open a discussion in the ["Feature Requests, Ideas"][feature-requests] category.
...
[closed-discussions]: https://github.com/zokugun/vscode-sync-settings/discussions?discussions_q=is%3Aclosed
[closed-issues]: https://github.com/zokugun/vscode-sync-settings/issues?q=is%3Aissue%20state%3Aclosed
[discussions]: https://github.com/zokugun/vscode-sync-settings/discussions
[feature-requests]: https://github.com/zokugun/vscode-sync-settings/discussions/new?category=feature-requests-ideas
[issue-triage]: https://github.com/zokugun/vscode-sync-settings/discussions/new?category=issue-triage
